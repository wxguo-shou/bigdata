...
//                .getExecutionEnvironment();  自动识别  远程集群  还是idea本地环境
                .getExecutionEnvironment(conf);   //  conf对象可以修改一些参数
//                .createLocalEnvironment();
//                .createRemoteEnvironment("hadoop102", 8081, "/***");


        env
                // 流批一体： 代码api是同一套  可以指定为 流  也可以指定为 批
                // 默认 STREAMING
...
//                .socketTextStream("hadoop102", 7777)
         ...
         *          一个main方法可以调用多个execute，但是没意义，指定到第一个就会阴赛住
     ...
     *          3、思考:
         ...
         *          =》 对应 Jobmanager当中，会有n个 JobMaster
         */
